...
export const STYLISTS = [
  {
    ...
    pal: { bg: '#D7FF3A', ink: '#0A0A0A', acc: '#FF3B1F', card: '#0A0A0A' }, pattern: 'zigzag',
  ...
  },
  {
    ...
    pal: { bg: '#FF3B1F', ink: '#FFFFFF', acc: '#FFE14A', card: '#1A0500' }, pattern: 'dots',
  ...
  },
  {
    ...
    pal: { bg: '#EDEDED', ink: '#0A0A0A', acc: '#2448FF', card: '#0A0A0A' }, pattern: 'lines',
  ...
  },
  {
    ...
    pal: { bg: '#1F5C3E', ink: '#FFF6E5', acc: '#FFC94A', card: '#0C2A1B' }, pattern: 'check',
  ...
  },
  {
    ...
    pal: { bg: '#3FC7FF', ink: '#0A1A2E', acc: '#FFE14A', card: '#0A1A2E' }, pattern: 'waves',
  ...
  },
  {
    ...
    pal: { bg: '#FFB23F', ink: '#2B1B0E', acc: '#C8261B', card: '#2B1B0E' }, pattern: 'block',
  ...
  },
  {
    ...
    pal: { bg: '#E0241B', ink: '#FFFFFF', acc: '#111111', card: '#111111' }, pattern: 'bolts',
  ...
  },
  {
    ...
    pal: { bg: '#B44CFF', ink: '#FFFFFF', acc: '#FFE14A', card: '#2A0A40' }, pattern: 'dots',
  ...
  },
  {
    ...
    pal: { bg: '#2E7D5B', ink: '#F3F7E8', acc: '#FFB23F', card: '#10301F' }, pattern: 'waves',
  ...
  },
  {
    ...
    pal: { bg: '#1640C8', ink: '#FFFFFF', acc: '#FF8A3D', card: '#071A5A' }, pattern: 'lines',
