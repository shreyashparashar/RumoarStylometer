...
// Where the fit is going. `line` sets the scene, `judged` is what the occasion pillar
// weighs most (shown on the occasion screen and sent to the AI), `code` is the dress code.
export const OCCASIONS = [
  { id: 'college',    name: 'College',        code: 'Casual',        line: 'Lectures, canteen, eight hours on your feet', judged: ['Comfort that still looks chosen', 'Clean sneakers', 'A bag that carries a laptop'] },
  { id: 'date-night', name: 'Date night',     code: 'Smart casual',  line: 'Dinner, drinks, a first impression',          judged: ['Fit at the shoulder and hem', 'A tight colour story', 'One detail worth noticing'] },
  { id: 'office',     name: 'Office',         code: 'Business casual', line: 'Meetings, desk to dinner',                  judged: ['Pressed, crease-free pieces', 'Restraint in colour', 'Proper shoes and a belt'] },
  { id: 'interview',  name: 'Interview',      code: 'Formal',        line: 'Twenty minutes to look like a yes',           judged: ['Tailored fit', 'Neutral palette', 'Nothing wrinkled, nothing loud'] },
  { id: 'wedding',    name: 'Wedding',        code: 'Festive formal', line: 'Sangeet, pheras, the family photo',          judged: ['Ethnic or sharp tailoring', 'Rich fabric', 'Finished with shoes and accessories'] },
  { id: 'party',      name: 'Party',          code: 'Night out',     line: 'Club, house party, late start',               judged: ['Darker palette or a bold piece', 'Something that catches light', 'Shoes you can stand in all night'] },
  { id: 'concert',    name: 'Concert',        code: 'Casual',        line: 'Crowds, lights, hands free',                  judged: ['Layers you can lose', 'Hands-free bag', 'Personality in one piece'] },
  { id: 'festival',   name: 'Festival',       code: 'Loud casual',   line: 'Sun, dust, dancing',                          judged: ['Colour or print', 'Breathable fabric', 'Crossbody, not a tote'] },
  { id: 'travel',     name: 'Travel day',     code: 'Casual',        line: 'Airport, long drive, arriving somewhere new',  judged: ['Layers for changing weather', 'No-fuss comfort', 'One bag that does everything'] },
];
