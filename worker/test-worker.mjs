...
const seenOut = { is_outfit_photo: true, framing: 'full body', garments: [{ item: 'denim jacket', colour: 'indigo', fit: 'regular' }, { item: 'jeans', colour: 'indigo', fit: 'slim' }], accessories: [], palette: ['indigo', 'white'], style_read: 'double denim casual' };
