...
Raw-denim indigo with copper-rivet accents, sharp 2–4 px corners. **Krona One** for the RUMOAR logo, **BDO Grotesk** (variable, 300–900) for everything else. Both are self-hosted in `assets/fonts/` as WOFF2, so nothing loads from Google Fonts.
